...
const Dashboard = () => {
  return (
    <DashboardLayout>
      <div className="dashboard-cont h-[90vh] md:bg-white md:shadow-2xl md:rounded-2xl md:bg-opacity-5 w-full md:w-[80%] md:ml-9 md:p-5  z-20 border-[0px] md:border-[1px] border-white border-opacity-10 overflow-scroll">
